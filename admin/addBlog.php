...
<div class="container">
  ...
  <form action="upload_blog.php" method="POST" enctype="multipart/form-data">
    ...
    <div class="form-group">
    	<label for="short">Blog Title</label>
    <textarea  rows="1" id="comment" name="title" placeholder="News Title" required="required" style="width: 100%; margin: 5px 0px; padding:2px 0px;"></textarea>
    </div>
    <div class="form-group">
